...
if __name__ == '__main__':
    ...
    # Выводит список каналов по заданному названию
    # выбрать свой канал и значение ID (если название введено полностью, обычно бывает первым в списке)
    # если ID будет 10-значным, добавить впереди префикс -100
    # пример: 1234567890 --> -1001234567890
    a = asyncio.run(searching_channels_by_title('Название канала'))  # поиск ID канала по названию
    print(a)
